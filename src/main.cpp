...
int main(int argc, char * argv[])
{
    ...
    auto window = SDL_CreateWindow("Neon", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, width, height, SDL_WINDOW_SHOWN);
    if (window)
    {
        ...
        if (renderer)
        {
            ...
            windowHandle = windowInfo.info.win.window;*/
            {
                ...
                browser = CefBrowserHost::CreateBrowserSync(window_info, browserClient.get(),  "http://localhost:4200/", browserSettings, nullptr, nullptr);
                        ...
                        case SDL_MOUSEBUTTONDOWN:
                            {
                                ...
                                Point  windowPos, newWindowPos, newWindowSize, mWindowResizeOffset;
                               POINT mousePos;
                                ...
                                if (ScreenToClient(windowHandle,&mousePos))
                                {
                                    mousePos.x =x;
                                     ...
                                     newWindowPos.x = newWindowPos.x + mousePos.x ;
                                    SDL_SetWindowPosition(window,mousePos.x , mousePos.y);
