...
{
    if(media_object.is_web_file==1){
      av_dict_set(&format_opts, "headers", media_object.headers, 0);
       av_dict_set(&format_opts, "cookies", media_object.cookies, 0);
       //av_dict_set(&format_opts, "autoexit", 1, 0);
     }
